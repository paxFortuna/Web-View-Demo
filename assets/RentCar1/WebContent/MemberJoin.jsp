...
<center>
	...
	<tr height="50">
		...
		<td width="350" align="center"><input type="text" name="id" size="40" placeholder="아이디 입력"></td>
	</tr>	
	<tr height="50">
		<td width="150" align="center">패스워드</td>
		<td width="350" align="center"><input type="password" name="pass1" size="40"
		placeholder="영문과 숫자 조합만 넣어주세요"></td>
	</tr>
	<tr height="50">
	...
	<tr height="50">
		...
		<td width="350" align="center"><input type="tel" name="tel" size="40" placeholder="전화번호 입력"></td>
	</tr>
	<tr height="50">
	...
	<tr height="50">
		<td colspan="2" align="center">		
			...
			<input type="reset" onclick="location.href='RentMain.jsp'" value="취소">
		</td>
	</tr>				
