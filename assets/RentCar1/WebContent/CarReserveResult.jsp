...
<%
	...
	Date d1 = new Date();
	Date d2 = new Date();
	//날짜를 2016-5-5 형식으로 포맷해주는 클래스 선언
	...
	//예약하려는 날짜보다 현재 날자가 크면 -1
	//예약하려는 날짜와 현재날짜가 같으면 0
	//예약하려는 날짜가더 크다면 1을 리턴
	...
	//결과적으로 아무런 문제가 엇다면 데이터 저장후 결과 페이지 보여주기
	//아이디 값이 빈클래스에 없기에
...
<table width="1000" >
	...
	<tr height="50">
		<td align="center" >
		<font size="5" color="red">차량 총예약 금액<%=totalcar %>원</font></td>	
	</tr>
	<tr height="50">
		<td align="center" >
	...
	<tr height="50">
		<td align="center" >
		<font size="5" color="red">차량 총 금액<%=totalcar+totaloption %>원</font></td>	
	</tr>
