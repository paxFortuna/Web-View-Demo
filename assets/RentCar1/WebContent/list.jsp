...
#search-form h1, #search-form legend {
  display: none;
}
...
.hamburger-button, .search-button, .more-vert-button {
  display: none;
}
...
.aside .menu.text-menu.first ul, .aside .menu.text-menu.first .list {
  border-top: none;
  margin-top: 0px;
}
...
.pager-item:hover, .pager>div:hover {
  text-decoration: underline;
}
...
.pager-item .btn-prev, .pager>div:last-child a, .pager>div:last-child span
  {
  width: 15px;
  height: 15px;
...
main .table input[type=text], main .table input[type=password], main .table input[type=email],
  main .table input[type=date], main .table input[type=number], main .table select
  {
  width: 90%;
  vertical-align: middle;
  height: 24px;
...
main .table input[type=text].width-auto, main .table input[type=password].width-auto,
  main .table input[type=number].width-auto, main .table select.width-auto
  {
  width: auto;
}

main .table input[type=text].width-half, main .table input[type=password].width-half,
  main .table input[type=email].width-half, main .table input[type=date].width-half,
  main .table select.width-half {
  width: 200px;
}

main .table input[type=text].width-small, main .table input[type=password].width-small,
...
main .table textarea, main .table .textarea {
  /* border:1px solid #e9e9e9;
	border-radius: 10px; */
  padding: 5px;
  width: 100%;
...
main .table.h50 th, main .table.h50 td {
  height: 50px;
}
...
main .table.dashed td, main .table.dashed th, main .table.dashed .td,
...
main .table tr.content td, main .table .tr.conent td {
  text-align: left;
  padding: 10px;
}

main .table tr.hidden, main .table .tr.hidden {
  display: none;
}

main .table td.title, main .table .td.title {
  overflow: hidden;
  white-space: nowrap;
  text-overflow: ellipsis;
}
...
main .table td.-text-.vertical.center>img, main .table td.-text-.vertical.center>label,
  main .table td.-text-.vertical.center>input {
  vertical-align: middle;
}

/* td 태그 안에 있는 모든 img, label, input에 각각 수직 가운데 정렬을 지정하는 스타일 */
main .table td input.-text-.vertical.center, main .table td img.-text-.vertical.center,
...
/* ==== 테블릿 이하에서 달라질 공통 Style 오버라이드-- 너비 959px 이하 =========================================================== */
@media all and (max-width:959px) {
  main {visual을 없애면서 마진을 주게 됨. margin-top:50px;
    width: 100%;
    padding: 0px;
  }
  main .breadcrumb {
...
%>  
 ...
 -->
      ...
      <!-- <section>
        ...
        <div class="sub-menu">
          ...
          <nav id="acount-menu">
            ...
            <div>
              <td><a href="RentMain.jps">HOME</a></td>
              <td><a href="RentMain.jsp?center=MemberLogin.jsp">로그인</a></td>
              <td><a href="RentMain.jsp?center=MemberJoin.jsp">회원가입</a></td>
            </div>
          </nav> -->
         ...
         <!--  <nav id="member-menu" class="linear-layout">
            ...
            <div class="linear-layout">
              <td><a href="MemberInfo.jsp"><img
                  src="/images/txt-mypage.png" alt="마이페이지" /></a></td>
              <td><a href="BoardList.jsp"><img
                  src="/images/txt-customer.png" alt="고객센터" /></a></td>
            </div>
          </nav> -->
        <!-- </div>
      </section>
  ...
  <!-- <div id="visual">
    ...
    <a href="RentMain.jsp"> <img src="img/LOGO.PNG"
      alt="HERMES Rent Car" /></a>

    <h1 padding-left: 10px; font-size: 50px;  font-weight:bold; >
      헤르메스 렌터카 방문을 환영합니다!!!</h1>
 ...
 -->
      ...
      <aside class="aside">
        ...
        <nav class="menu text-menu first margin-top">
          <h1>고객센터메뉴</h1>
          <ul>
            <li><a class="current" href="detail.jsp">공지사항</a></li>
        ...
        <nav class="menu">
          <h1>협력업체</h1>
          <ul>
            <li><a target="_blank" href="http://www.naver.com"><img
                src="/images/notepubs.png" alt="네이버" /></a></li>
            <li><a target="_blank" href="http://www.google.com"><img
                src="/images/namoolab.png" alt="구글" /></a></li>
          </ul>
        </nav>
      ...
      <main class="main">
        ...
        <div class="search-form margin-top first align-right">
          ...
          <form class="table-form" action="list.do" method="post">
            <fieldset>
          ...
          <div>
            ...
            <c:if test="${startNum+4 >=lastNum }">
              <span class="btn btn-next"
                onclick="alert('다음 페이지가 없습니다.');">다음</span>
            </c:if>
        ...
        <table>
          <tr height="100">
            <td align="center">
              ...
              (주)HERMES RentCar 사업자 정보 | ()주)크크 | 서울시 서초구 율곡로 111, 3층 <br> 대표 :아이유
              | 개인정보보호책임 :아이린<br> 사업자등록번호 : 613-81-65333 통신판매업신고 :
              2021-서울강남-01555호<br> tel 1555-5555 | h55p@google.com
